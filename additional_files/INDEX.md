...
| `stability_tool_source.zip` | Full source: React app, Express API with tests, reference and history importers, schema generator with the refresh script, Bicep and deploy script, report builder | Unzip; `npm install` in the app root and `sdct/backend/api/` |
