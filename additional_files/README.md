...
Open `../dist-mockup/index.html` in a browser (or `Stability_Capture_Mockup.html` from the delivery folder). It runs entirely in the browser with 120 seeded observations across 5 ARs. Switch persona (scientist, reviewer, admin) from the top right to see role-based access change what the app offers.
